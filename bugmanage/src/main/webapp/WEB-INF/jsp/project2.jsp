...
<input type="hidden" id="hidtype" value="1" />
    ...
    <div class="header bg-white">
        ...
        <div class="head-nav f-l color-8">
            <span class="color-2 f-l p-relative cursorpointer" onclick="window.location.href='user/index'" >
        ...
        <div class="about-system d-none">
            ...
            <div class="info">
                ...
                <p class="copyright">奇创科技创新团队版权所有<br />bugdone.cn</p>
            </div>
        </div>     
        ...
        <div class="package-system d-none">
            ...
            <div class="info">
                ...
                <p class="copyright">如有疑问欢迎联系BugDone团队<br />Email：XXXX@xxxx.com</p>
            </div>
        </div>
        <!--        
    ...
    <div class="left p-absolute bg-white" id="project-left" style='border-right:none;overflow: auto;'>
            ...
            <div class="menu fz-14">
                <ul>
                    <li class="on">
                    	<a href="items/project1?id=${itemsid}&&actionnumber=${actionnumber }&&problemnumber=${problemnumber}">
                    		<i class="icon-gk"></i>项目概况
                    	</a>
                    </li>
                    <li>
                    	<a href="items/project2?id=${itemsid}&&actionnumber=${actionnumber }&&problemnumber=${problemnumber}">
                    		<span class="num f-r n-bg1" id="lblUnsolvedProblemNum">${actionnumber}</span>
                    		<i class="icon-wt"></i>活动问题
                    	</a>
                    </li>
                    <li>
                    	<a href="items/project3?id=${itemsid}&&actionnumber=${actionnumber }&&problemnumber=${problemnumber}">
                    		<i class="icon-all"></i>所有问题
                    	</a>
                    </li>
                    <li>
                    	<a href="items/project4?id=${itemsid}&&actionnumber=${actionnumber }&&problemnumber=${problemnumber}">
                ...
                <ul>
                    <li>
                    	<a href="items/project5?id=${itemsid}&&actionnumber=${actionnumber }&&problemnumber=${problemnumber}">
                    		<span class="num f-r n-bg2" id="lblMyToDoProblemNum">${problemnumber}</span>
                    		<i class="icon-daiban"></i>我的待办
                    	</a>
                    </li>
                    <li>
                    	<a href="items/project6?id=${itemsid}&&actionnumber=${actionnumber }&&problemnumber=${problemnumber}">
                    		<i class="icon-fenpei"></i>分配给我
                    	</a>
                    </li>
                    <li>
                    	<a href="items/project7?id=${itemsid}&&actionnumber=${actionnumber }&&problemnumber=${problemnumber}">
                ...
                <ul>
                     <li>
                     	<a href="items/project8?id=${itemsid}&&actionnumber=${actionnumber }&&problemnumber=${problemnumber}">
                     		<i class="icon-fb"></i>版本管理
                     	</a>
                     </li>
                    <li>
                    	<a href="items/project9?id=${itemsid}&&actionnumber=${actionnumber }&&problemnumber=${problemnumber}">
            ...
            <div class="mw-900 rightshow">
                ...
                <div class="filter bg-white f-l b-radius4 bs-08">
                    <ul>
                        ...
                        <li>
                            <div class="btn">指派给：<span>全部</span><i class="iconfont icon-bottom"></i></div>
                            <div class="box">
                        ...
                        <li>
                            <div class="btn">计划时间：<span>全部</span><i class="iconfont icon-bottom"></i></div>
                            <div class="box">
                                <label><input name="time" value="0" type="radio">全部</label>
                                <label><input name="time" value="1" type="radio">已过期</label>
                                <label><input name="time" value="2" type="radio">今天</label>
                                <label><input name="time" value="3" type="radio">今天开始</label>
                                <label><input name="time" value="4" type="radio">今天结束</label>
                                <label><input name="time" value="5" type="radio">明天</label>
                                <label><input name="time" value="6" type="radio">明天开始</label>
                                <label><input name="time" value="7" type="radio">明天结束</label>
                                <label><input name="time" value="8" type="radio">本周</label>
                                <label><input name="time" value="9" type="radio">本周开始</label>
                                <label><input name="time" value="10" type="radio">本周结束</label>
                                <label><input name="time" value="11" type="radio">下周</label>
                                <label><input name="time" value="12" type="radio">下周开始</label>
                                <label><input name="time" value="13" type="radio">下周结束</label>
                                <label><input name="time" value="14" type="radio">已开始</label>
                                <label><input name="time" value="15" type="radio">未开始</label>
                                <label><input name="time" value="16" type="radio">已计划</label>
                                <label><input name="time" value="17" type="radio">未计划</label>
                            </div>
                        </li>
                    </ul>
                </div>
                <style>
                    ...
                    .atclass{display:none}
                </style>
                
                <div class="clear"></div>

                <div class="problem-list bg-white bs-08 b-radius4 of-hidden animated bounceInUp">
                    <div class="title fz-16">活动问题<span class="fz-12 color-8" id="count">共${fn:length(list)}条记录</span></div>
                    <table class="ta-center color-8" width="100%" cellspacing="0" cellpadding="0"> 
                                <tr class="tr-head"> 
                            <!--bottom-on选中降序  top-on选中升序-->
                            <td class="td-first" nowrap style="width: 65px;"><a href="items/itemssort?id=${itemsid}&&actionnumber=${actionnumber }&&problemnumber=${problemnumber}&&type=1&&action=p2&&order=${order}" class="top-on"><span class="icon"><i class="iconfont icon-top" onclick="loaddate('BugCode',this);"></i><i class="iconfont icon-bottom" onclick="loaddate('BugCode',this);"></i></span>编号</a></td>
                            <td nowrap style="width: 55px;"><a href="items/itemssort?id=${itemsid }&&actionnumber=${actionnumber }&&problemnumber=${problemnumber}&&type=2&&action=p2&&order=${order}" class="bottom-on"><span class="icon"><i class="iconfont icon-top" onclick="loaddate('BugType',this);"></i><i class="iconfont icon-bottom" onclick="loaddate('BugType',this);"></i></span>类型</a></td>
                            <td class="ta-left" style="width: 750px;"><a href="#" class="top-on">标题</a></td>
                            <td nowrap style="width: 55px;"><a href="items/itemssort?id=${itemsid }&&actionnumber=${actionnumber }&&problemnumber=${problemnumber}&&type=3&&action=p2&&order=${order}" class="top-on"><span class="icon"><i class="iconfont icon-top" onclick="loaddate('BugStatus',this);"></i><i class="iconfont icon-bottom" onclick="loaddate('BugStatus',this);"></i></span>状态</a></td>
                            <td nowrap style="width: 65px;"><a href="items/itemssort?id=${itemsid }&&actionnumber=${actionnumber }&&problemnumber=${problemnumber}&&type=4&&action=p2&&order=${order}"><span class="icon"><i class="iconfont icon-top" onclick="loaddate('Priority',this);"></i><i class="iconfont icon-bottom" onclick="loaddate('Priority',this);"></i></span>优先级</a></td>
                            <td nowrap style="width: 65px;"><a href="items/itemssort?id=${itemsid }&&actionnumber=${actionnumber }&&problemnumber=${problemnumber}&&type=5&&action=p2&&order=${order}" class="top-on"><span class="icon"><i class="iconfont icon-top" onclick="loaddate('ProcessingUserId',this);"></i><i class="iconfont icon-bottom" onclick="loaddate('ProcessingUserId',this);"></i></span></a>指派给</td>
                            <td nowrap style="width: 83px;"><a href="items/itemssort?id=${itemsid }&&actionnumber=${actionnumber }&&problemnumber=${problemnumber}&&type=6&&action=p2&&order=${order}"><span class="icon"><i class="iconfont icon-top" onclick="loaddate('CreateTime',this);"></i><i class="iconfont icon-bottom" onclick="loaddate('CreateTime',this);"></i></span>创建时间</a></td>
                            <td nowrap style="width: 94px;" class="td-last"><a href="items/itemssort?id=${itemsid }&&actionnumber=${actionnumber }&&problemnumber=${problemnumber}&&type=7&&action=p2&&order=${order}" class="bottom-on"><span class="icon"><i class="iconfont icon-top" onclick="loaddate('ModifyTime',this);"></i><i class="iconfont icon-bottom" onclick="loaddate('ModifyTime',this);"></i></span>修改时间</a></td>
                         </tr> 
